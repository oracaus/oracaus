...
//     `ToastEntry` body for the rationale — synchronous
...
// Minimal breathing room above the viewport edge — tight enough that
...
function ToastEntry({
  ...
  return (
    <div
      ...
      // list keeps the transition off the main paint thread —
